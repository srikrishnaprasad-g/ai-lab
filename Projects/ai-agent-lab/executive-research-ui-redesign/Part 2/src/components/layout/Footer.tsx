...
export const Footer = () => {
  return (
    <footer className="w-full mt-auto border-t border-hairline">
      <div className="w-full max-w-[720px] mx-auto px-6 py-8 flex items-center justify-between">
        <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-slate-soft">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            <a
              ...
              title="LinkedIn"
              className="flex h-7 w-7 items-center justify-center rounded-full border border-hairline text-slate-soft transition-colors duration-150 hover:border-brass hover:text-brass focus-brass"
            >
              <LinkedInIcon />
            </a>
            <a
